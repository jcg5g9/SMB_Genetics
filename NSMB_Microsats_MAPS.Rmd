...
plot(shape_smb, col = "gray94", border = T, axes=T, ylim = c(35.5,37.5), xlim = c(-96,-91), cex.axis = 2)
plot(shape_neosho, add = T, col = "grey67", border = T, axes = T, ylim = c(35.5,37.5), xlim = c(-96,-91), cex.axis = 2)
plot(shape_river, add = T, col = "blue", border = T, axes = T, ylim = c(35.5,37.5), xlim = c(-96,-91), cex.axis = 2)
plot(shape_crooked_creek, add = T, col = "blue", border = T, axes = T, ylim = c(35.5,37.5), xlim = c(-96,-91), cex.axis = 2)
plot(shape_tablerock_creek, col = "blue", add = T, border = F, axes = T, ylim = c(35.5,37.5), xlim = c(-96,-91), cex.axis = 2)
plot(shape_skiatook_lake, add = T, col = "blue", border = F, ylim = c(35.5,37.5), xlim = c(-96,-91), cex.axis = 2)
plot(shape_stockton_lake, add = T, col = "blue", border = F, ylim = c(35.5,37.5), xlim = c(-96,-91), cex.axis = 2)
scalebar(200, xy = c(-96, 34.85), type = "bar", adj = c(0.4, -1),  divs = 4, cex = 3)
#c(-96,91)

shape_tablerock_creek@proj4string
