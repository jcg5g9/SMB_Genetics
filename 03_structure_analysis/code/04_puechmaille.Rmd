...
##### 4c.4. Submit zip directory to Structure Selector or Structure Harvester to extract summary results
...
#### 4d. Plot deltaK results and STRUCTURE runs at best K value (according to deltak statistic) for each analysis
...
##### 4d.2. Plot STRUCTURE results for default parameters; run the Rmd chunk below.
