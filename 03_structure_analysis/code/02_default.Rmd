...
for(ii in 1:nrow(nk)) {
  ...
  for(aa in 1:nrow(nreps)) {
    ...
    output <- paste(" -o /home/jcg5g9/data/SMB_Genetics/03_structure_analysis/data/structure_data/output_data/default/")
...
for(ii in 1:nrow(nk)) {
  ...
  for(aa in 1:nrow(nreps)) {
    ...
    output <- paste(" -o /home/jcg5g9/data/SMB_Genetics/03_structure_analysis/data/structure_data/output_data/default/neosho/")
...
for(ii in 1:nrow(nk)) {
  ...
  for(aa in 1:nrow(nreps)) {
    ...
    output <- paste(" -o /home/jcg5g9/data/SMB_Genetics/03_structure_analysis/data/structure_data/output_data/default/northern")
