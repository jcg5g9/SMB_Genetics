---
title: "Analysis 2 - Phase 2: Structure analysis with default STRUCTURE parameters"
author: "Joe Gunn"
date: "2022-08-13"
...
In this phase of analysis, we are assessing hierarchical population genetic structure among Spotted Bass, Northern Smallmouth Bass, and Neosho Smallmouth Bass populations in the CIH using default parameter settings in the software program STRUCTURE. 

### STEP 1: Generate batch list files and shell scripts for running STRUCTURE in parallel
...
for(ii in 1:nrow(nk)) {
  ...
  for(aa in 1:nrow(nreps)) {
    ...
    output <- paste(" -o /home/jcg5g9/data/SMB_Genetics/03_structure_analysis/data/structure_data/output_data/structure_output_default/")
    ...
    cat(paste(structure_call, "-K ", nk[ii,], param_files, input, output,
      ...
      "\n", 
      file = paste("batch_cmd_lists/default_structure_batch_cmd_list.txt"),
      append = TRUE)
  }
}
```
...
#COMMANDA=`head -n ${SLURM_ARRAY_TASK_ID} ../batch_cmd_lists/default_structure_batch_cmd_list.txt | tail -n 1`
#eval $COMMANDA
