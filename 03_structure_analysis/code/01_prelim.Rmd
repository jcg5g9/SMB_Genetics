...
save(evanno, file = "../data/structure_data/deltak_data/prelim_deltak.Rda")
...
<b>Model results</b>:
There is no evidence of population structure (deltaK < ~30.00) beyond K=15, so we are using K=15 as the maximum number of possible clusters for all subsequent analyses to reduce computation time and provide more accurate estimates of optimal K.

## ------------------------ END OF PHASE 1: STEP 1 (MODEL 1) ----------------------- ##
