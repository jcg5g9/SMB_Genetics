...
## notifications
#SBATCH --mail-user=jcgunn@uvm.edu  # email address for notifications
...
COMMANDA=`head -n ${SLURM_ARRAY_TASK_ID} ../batch_cmd_lists/default_northern_batch_cmd_list.txt | tail -n 1`
eval $COMMANDA
