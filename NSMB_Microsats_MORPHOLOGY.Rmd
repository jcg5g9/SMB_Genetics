...
sl_range_mean <- morph_all %>% 
    group_by(range) %>% 
    summarize(mean_log = mean(logsl), mean_raw = mean(standard_length))

ol_range_mean <- morph_all %>% 
    group_by(range) %>% 
    summarize(mean_log = mean(logol), mean_raw = mean(orbital_length))

hl_range_mean <- morph_all %>%
    group_by(range) %>% 
    summarize(mean_log = mean(loghl), mean_raw = mean(head_length))

bd_range_mean <- morph_all %>% 
    group_by(range) %>% 
    summarize(mean_log = mean(logbd), mean_raw = mean(body_depth))
...
sl_gen_mean_k3 <- morph_90_nor_neo_k3 %>% 
    group_by(gid) %>% summarize(mean_log = mean(logsl), mean_raw = mean(sl))

ol_gen_mean_k3 <- morph_90_nor_neo_k3 %>% 
    group_by(gid) %>% summarize(mean_log = mean(logol), mean_raw = mean(ol))

hl_gen_mean_k3 <- morph_90_nor_neo_k3 %>% 
    group_by(gid) %>% summarize(mean_log = mean(loghl), mean_raw = mean(hl))

bd_gen_mean_k3 <- morph_90_nor_neo_k3 %>% 
    group_by(gid) %>% summarize(mean_log = mean(logbd), mean_raw = mean(bd)) 
...
sl_tl_range <- ggplot() + 
    geom_point(data = morph_all_neo, aes(x = total_length, y = standard_length, group = range, fill = range, shape = range), size = 4, pch = 21, color = "black", show.legend = T) +
    geom_smooth(data = morph_all_neo, aes(x = total_length, y = standard_length, color = range), show.legend = F, method = "lm", fullrange = T) +
    geom_point(data = morph_all_nor, aes(x = total_length, y = standard_length, fill = range, shape = range), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_all_nor, aes(x = total_length, y = standard_length, color = range), show.legend = F, method = "lm", fullrange = T) +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
...
ol_tl_range <- ggplot() + 
    geom_point(data = morph_all_neo, aes(x = total_length, y = orbital_length, group = range, fill = range, shape = range), size = 4, pch = 21, color = "black", show.legend = F) +
    geom_smooth(data = morph_all_neo, aes(x = total_length, y = orbital_length, color = range), show.legend = F, method = "lm", fullrange = T) +
    geom_point(data = morph_all_nor, aes(x = total_length, y = orbital_length, fill = range, shape = range), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_all_nor, aes(x = total_length, y = orbital_length, color = range), show.legend = F, method = "lm", fullrange = T) +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
hl_tl_range <- ggplot() + 
    geom_point(data = morph_all_neo, aes(x = total_length, y = head_length, group = range, fill = range, shape = range), size = 4, pch = 21, color = "black", show.legend = F) +
    geom_smooth(data = morph_all_neo, aes(x = total_length, y = head_length, color = range), show.legend = F, method = "lm", fullrange = T) +
    geom_point(data = morph_all_nor, aes(x = total_length, y = head_length, fill = range, shape = range), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_all_nor, aes(x = total_length, y = head_length, color = range), show.legend = F, method = "lm", fullrange = T) +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
bd_tl_range <- ggplot() + 
    geom_point(data = morph_all_neo, aes(x = total_length, y = body_depth, group = range, fill = range, shape = range), size = 4, pch = 21, color = "black", show.legend = F) +
    geom_smooth(data = morph_all_neo, aes(x = total_length, y = body_depth, color = range), show.legend = F, method = "lm", fullrange = T) +
    geom_point(data = morph_all_nor, aes(x = total_length, y = body_depth, fill = range, shape = range), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_all_nor, aes(x = total_length, y = body_depth, color = range), show.legend = F, method = "lm", fullrange = T) +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
range_grid <- plot_grid(sl_tl_range, ol_tl_range, hl_tl_range, bd_tl_range, nrow = 4, labels = c("a","c","e","g"), label_x = 0.001, label_y = 1.02, label_size = 30)


#Only Pure Samples
sl_tl_gen <- ggplot() + 
    geom_point(data = morph_neo_90_k3, aes(x = tl, y = sl, group = gid, fill = gid, shape = gid), size = 4, pch = 21, color = "black", show.legend = F) +
    geom_smooth(data = morph_neo_90_k3, aes(x = tl, y = sl, color = gid), show.legend = F, method = "lm", fullrange = T) +
    geom_point(data = morph_nor_90_k3, aes(x = tl, y = sl, fill = gid, shape = gid), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_nor_90_k3, aes(x = tl, y = sl, color = gid), show.legend = F, method = "lm", fullrange = T) +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
ol_tl_gen <- ggplot() + 
    geom_point(data = morph_neo_90_k3, aes(x = tl, y = ol, group = gid, fill = gid, shape = gid), size = 4, pch = 21, color = "black", show.legend = F) +
    geom_smooth(data = morph_neo_90_k3, aes(x = tl, y = ol, color = gid), show.legend = F, method = "lm", fullrange = T) +
    geom_point(data = morph_nor_90_k3, aes(x = tl, y = ol, fill = gid, shape = gid), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_nor_90_k3, aes(x = tl, y = ol, color = gid), show.legend = F, method = "lm", fullrange = T) +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
hl_tl_gen <- ggplot() + 
    geom_point(data = morph_neo_90_k3, aes(x = tl, y = hl, group = gid, fill = gid, shape = gid), size = 4, pch = 21, color = "black", show.legend = F) +
    geom_smooth(data = morph_neo_90_k3, aes(x = tl, y = hl, color = gid), show.legend = F, method = "lm", fullrange = T) +
    geom_point(data = morph_nor_90_k3, aes(x = tl, y = hl, fill = gid, shape = gid), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_nor_90_k3, aes(x = tl, y = hl, color = gid), show.legend = F, method = "lm", fullrange = T) +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
bd_tl_gen <- ggplot() + 
    geom_point(data = morph_neo_90_k3, aes(x = tl, y = bd, group = gid, fill = gid, shape = gid), size = 4, pch = 21, color = "black", show.legend = F) +
    geom_smooth(data = morph_neo_90_k3, aes(x = tl, y = bd, color = gid), show.legend = F, method = "lm", fullrange = T) +
    geom_point(data = morph_nor_90_k3, aes(x = tl, y = bd, fill = gid, shape = gid), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_nor_90_k3, aes(x = tl, y = bd, color = gid), show.legend = F, method = "lm", fullrange = T) +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
gen_grid <- plot_grid(sl_tl_gen, ol_tl_gen, hl_tl_gen, bd_tl_gen, nrow = 4, labels = c("b","d","f","h"), label_x = 0.001, label_y = 1.02, label_size = 30)


###Plot everything together
pdf("/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Microsatellites/visualization/morphology_figures/morph_size_corrections_mm.pdf", width = 14, height = 20)

plot_grid(range_grid, gen_grid, align = "v", axis = "l", ncol = 2)
...
pdf("/Users/joegunn/Desktop/Grad_School_Stuff/Research/Projects/Smallmouth_Bass_Microsatellites/visualization/morphology_figures/fin_logistic_regression.pdf", width=8, height=6)

ggplot(morph_gen_logit, aes(x = neosho_prop, y = rays)) + 
    geom_point(aes(fill = range), position = position_jitter(height = 0.05), show.legend = F, size = 4, color = "black", pch=21) + 
