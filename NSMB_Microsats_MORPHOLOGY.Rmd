...
sl_tl_range <- ggplot() + 
    ...
    geom_smooth(data = morph_all_neo, aes(x = total_length, y = standard_length, color = range), show.legend = F, method = "lm") +
    ...
    geom_smooth(data = morph_all_nor, aes(x = total_length, y = standard_length, color = range), show.legend = F, method = "lm") +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
...
ol_tl_range <- ggplot() + 
    ...
    geom_smooth(data = morph_all_neo, aes(x = total_length, y = orbital_length, color = range), show.legend = F, method = "lm") +
    ...
    geom_smooth(data = morph_all_nor, aes(x = total_length, y = orbital_length, color = range), show.legend = F, method = "lm") +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
hl_tl_range <- ggplot() + 
    ...
    geom_smooth(data = morph_all_neo, aes(x = total_length, y = head_length, color = range), show.legend = F, method = "lm") +
    ...
    geom_smooth(data = morph_all_nor, aes(x = total_length, y = head_length, color = range), show.legend = F, method = "lm") +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
bd_tl_range <- ggplot() + 
    ...
    geom_smooth(data = morph_all_neo, aes(x = total_length, y = body_depth, color = range), show.legend = F, method = "lm") +
    ...
    geom_smooth(data = morph_all_nor, aes(x = total_length, y = body_depth, color = range), show.legend = F, method = "lm") +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
range_grid <- plot_grid(sl_tl_range, ol_tl_range, hl_tl_range, bd_tl_range, nrow = 4, labels = c("a","c","e","g"), label_x = 0.15, label_y = 0.98, label_size = 30)


#Only Pure Samples
sl_tl_gen <- ggplot() + 
    geom_point(data = morph_neo_90_k3, aes(x = tl, y = sl, group = gid, fill = gid, shape = gid), size = 4, pch = 21, color = "black", show.legend = F) +
    geom_smooth(data = morph_neo_90_k3, aes(x = tl, y = sl, color = gid), show.legend = F, method = "lm") +
    geom_point(data = morph_nor_90_k3, aes(x = tl, y = sl, fill = gid, shape = gid), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_nor_90_k3, aes(x = tl, y = sl, color = gid), show.legend = F, method = "lm") +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
ol_tl_gen <- ggplot() + 
    ...
    geom_smooth(data = morph_neo_90_k3, aes(x = tl, y = ol, color = gid), show.legend = F, method = "lm") +
    geom_point(data = morph_nor_90_k3, aes(x = tl, y = ol, fill = gid, shape = gid), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_nor_90_k3, aes(x = tl, y = ol, color = gid), show.legend = F, method = "lm") +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
    scale_y_continuous(breaks = c(10.0,12.5,15.0,17.5,20.0)) +
...
hl_tl_gen <- ggplot() + 
    ...
    geom_smooth(data = morph_neo_90_k3, aes(x = tl, y = hl, color = gid), show.legend = F, method = "lm") +
    geom_point(data = morph_nor_90_k3, aes(x = tl, y = hl, fill = gid, shape = gid), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_nor_90_k3, aes(x = tl, y = hl, color = gid), show.legend = F, method = "lm") +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
bd_tl_gen <- ggplot() + 
    ...
    geom_smooth(data = morph_neo_90_k3, aes(x = tl, y = bd, color = gid), show.legend = F, method = "lm") +
    geom_point(data = morph_nor_90_k3, aes(x = tl, y = bd, fill = gid, shape = gid), size = 4, pch = 22, color = "black", show.legend = F) +
    geom_smooth(data = morph_nor_90_k3, aes(x = tl, y = bd, color = gid), show.legend = F, method = "lm") +
    theme_set(theme_cowplot(12)) + 
    scale_fill_manual(values = c("springgreen3", "mediumpurple")) +
    scale_color_manual(values = c("springgreen3", "mediumpurple")) +
    scale_shape_manual(values = c("circle","square")) +
...
gen_grid <- plot_grid(sl_tl_gen, ol_tl_gen, hl_tl_gen, bd_tl_gen, nrow = 4, labels = c("b","d","f","h"), label_x = 0.12, label_y = 0.98, label_size = 30)
...
plot_grid(range_grid, gen_grid, align = "hv", axis = "l", ncol = 2)
